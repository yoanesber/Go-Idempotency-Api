...
APP_CONTAINER_IMAGE=my-idempotency-app
APP_CONTAINER_NAME=idempotency-app
APP_DOCKER_CONTEXT=.
...
REDIS_CONTAINER_IMAGE=my-idempotency-redis
REDIS_CONTAINER_NAME=idempotency-redis
REDIS_DOCKERFILE=./docker/redis/Dockerfile
REDIS_DOCKER_CONTEXT=.
REDIS_PORT=6379

# Variables for the PostgreSQL container
POSTGRES_CONTAINER_IMAGE=my-idempotency-postgres
POSTGRES_CONTAINER_NAME=idempotency-postgres
